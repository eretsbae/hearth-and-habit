...
- **Pinterest 자동 게시**: 글마다 세로형 핀 이미지(1000×1500)를 자동 생성하고, 매일 3개씩 자동으로 Pinterest에 올립니다. 검색 색인이 아직 안 잡힌 신규 사이트가 실제 방문자와 외부 링크를 확보하는 가장 빠른 경로입니다. 설정: **[docs/PINTEREST_SETUP.md](PINTEREST_SETUP.md)**
...
- [ ] 발행 글 25~30편 이상 (주 5회 기준 약 2~3주 후)
