...
- (선택) [Google Search Console](https://search.google.com/search-console)에 `peterpb.blogspot.com`을 속성으로 등록하면 검색 유입 데이터를 볼 수 있습니다 (도메인 소유권 인증 없이 URL 접두어 방식으로 등록 가능)
